...
{
puts("[pme] app_delayed_action_init...\r\n");

	Main_Init();
puts("[pme] app_delayed_action_1000ms...\r\n");
    aos_post_delayed_action(1000, app_delayed_action_1000ms, NULL);
    aos_post_delayed_action(FRAME_MS, app_delayed_action_100ms, NULL);
}
...
static void proc_main_entry(void *pvParameters)
{
	...
	puts("[pme] __opt_feature_init...\r\n");
    //__opt_feature_init();
puts("[pme] aos_loop_init...\r\n");
    //aos_loop_init();
